...
const Home = ({ data, router }: { data: any; router: any }) => {
  return (
    <>
      <HeroSection country={data?.country} />
      <div className='max-w-[1120px] mx-auto px-5 mb-[400px]'>
        ...
        <div className='mt-16 space-y-12'>
          <ScrollSpy>
            ...
            {data?.scholarships && <Scholarships data={data?.scholarships} index='3'/>}
            {data?.intakes && (
              <Intakes
                data={data?.intakes}
            ...
            {data?.costOfStudy && <CostOfStudy data={data?.costOfStudy} index='5'/>}
            {data?.livingExpenses && (
