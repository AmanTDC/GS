...
const Banner = () => {
  return (
    <div className='rounded-3xl lg:justify-between gap-8 items-center flex lg:flex-row flex-col bg-blue-500 -mt-[270px] lg:px-10 lg:pl-14 lg:mx-[60px] z-10 mb-16'>
      <Img
